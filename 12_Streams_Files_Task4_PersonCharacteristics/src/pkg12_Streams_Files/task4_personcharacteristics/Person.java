...
import pkg12_Streams_Files.task4_personcharacteristics.Address;
...
final class Person {
    ...
    private List<Address> pastAdresses = new ArrayList<Address>();
   ...
   public String toString(){
        ...
        if(education.get(education.size()-1).isGraduated()){
            ...
            if( ! education.get(education.size()-1).getDegree().equalsIgnoreCase("Primary")) {
                    ...
                    result += String.format(" %s grade was %.3f.", hisOrHer, ((GradedEducation) education.get(education.size()-1)).getFinalGrade());
